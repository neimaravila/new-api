...
export const STATIC_I18N_KEYS = [
  ...
  '{{days}} days',
  '{{failures}} recent failures · {{channels}} channels need review',
  '{{latency}} ms',
  '{{quota}} quota remaining',
  '{{requests}} requests in the last 24 hours · {{keys}} active keys',
  '{{requests}} requests · {{quota}} quota used',
  'A channel has high latency',
  'A single user accounts for most recent quota consumption.',
  'Add credits before sending more paid requests.',
  'Balance depleted',
  'Balance may run out soon',
  'Channel health',
  'Check model usage and recent logs to confirm the increase is expected.',
  'Consider using a cheaper model for test traffic if quality requirements allow it.',
  'Compare Pricing',
  'Create API Key',
  'Create an API key before sending production traffic through the gateway.',
  ...
  'Healthy',
  'Last 24 hours',
  'Investigate upstream availability or routing priority for this provider.',
  'Latency',
  'Manage channels',
  'Model usage',
  'Needs API key',
  'Needs attention',
  'No urgent insights',
  'One API key has no recent traffic',
  'One model dominates recent cost',
  'One model dominates recent spend',
  'Open Analytics',
  'Open Wallet',
  'Open Playground',
  'Platform command center',
  'Prompt, completion, and cache tokens',
  'Quota used',
  'Ready',
  'Ready-to-run request',
  'Recent activity',
  'Recent failed requests',
  'Recent failed requests crossed the operational warning threshold.',
  'Recent requests',
  'Recent requests failed',
  'Review API Keys',
  'Review Channels',
  'Review failed requests to fix model, key, or request payload issues.',
  'Review pricing and routing rules for the most expensive model traffic.',
  'Review top users and models to confirm the increase is expected.',
  'Review Users',
  'Runway',
  'Rule-based recommendations from recent platform activity',
  'Send a test request or remove unused keys to keep your integration tidy.',
  'Smart insights',
  'Smart insights are temporarily unavailable.',
  'Spend is concentrated in one user',
  ...
  'Top users',
  'Unused keys',
  'Usage increased versus the previous period',
  'Usage is up versus the previous period',
  'View Logs',
  'View Models',
  'View Usage',
