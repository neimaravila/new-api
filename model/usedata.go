...
// FillQuotaDataDisplayNames populates DisplayName from the users table (main DB).
// Done in memory because quota_data may live in a separate/log database.
func FillQuotaDataDisplayNames(rows []*QuotaData) {
