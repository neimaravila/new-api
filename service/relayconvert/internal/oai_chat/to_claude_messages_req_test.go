...
// newReqCtx devolve um *gin.Context válido p/ os conversores que o exigem.
func newReqCtx() *gin.Context {
...
func TestOpenAIChatRequestToClaudeMessages_WebSearchToolCallBecomesServerTool(t *testing.T) {
	...
	out, err := OpenAIChatRequestToClaudeMessages(newReqCtx(), req)
